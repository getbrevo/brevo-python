...
try:
    ...
    api_response = client.account.get_account()
    pprint(api_response)
except Exception as e:
    print(f"Exception: {e}")
```

### For Legacy SDK (v3.x and below)

If you are using an older version, please use the following import and initialization:
