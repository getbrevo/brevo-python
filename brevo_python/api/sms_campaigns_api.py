...
class SMSCampaignsApi(object):
    ...
    def send_test_sms(self, campaign_id, phone_number, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int campaign_id: Id of the SMS campaign (required)
        :param SendTestSms phone_number: Mobile number of the recipient with the country code. This number must belong to one of your contacts in Brevo account and must not be blacklisted (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
