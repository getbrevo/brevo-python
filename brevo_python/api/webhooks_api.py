...
class WebhooksApi(object):
    ...
    def export_webhooks_history(self, export_webhook_history, **kwargs):  # noqa: E501
        """Export all transactional events  # noqa: E501

        This endpoint will submit a request to get the history of webhooks in the CSV file. The link to download that CSV file will send to the webhook link provided in notifyURL of the body payload.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.export_webhooks_history(export_webhook_history, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ExportWebhooksHistory export_webhook_history: Values to submit for webhooks history (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.export_webhooks_history_with_http_info(export_webhook_history, **kwargs)  # noqa: E501
        else:
            (data) = self.export_webhooks_history_with_http_info(export_webhook_history, **kwargs)  # noqa: E501
            return data

    def export_webhooks_history_with_http_info(self, export_webhook_history, **kwargs):  # noqa: E501
        """Export all transactional events  # noqa: E501

        This endpoint will submit a request to get the history of webhooks in the CSV file. The link to download that CSV file will send to the webhook link provided in notifyURL of the body payload.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.export_webhooks_history_with_http_info(export_webhook_history, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['export_webhook_history']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method export_webhooks_history" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'export_webhook_history' is set
        if ('export_webhook_history' not in params or
                params['export_webhook_history'] is None):
            raise ValueError("Missing the required parameter `export_webhook_history` when calling `export_webhooks_history`")  # noqa: E501
        ...
        body_params = None
        if 'export_webhook_history' in params:
            body_params = params['export_webhook_history']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
