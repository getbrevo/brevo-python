...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "GetParameterSubscriptionInfoResponseBalance": ".types",
    "GetParameterSubscriptionInfoResponseBalanceBalancesItem": ".types",
    "GetParameterSubscriptionInfoResponseMembersItem": ".types",
    "GetParameterSubscriptionInfoResponseRewardItem": ".types",
    "GetParameterSubscriptionInfoResponseTierItem": ".types",
    "SubscribeMemberToASubscriptionResponse": ".types",
    "SubscribeToLoyaltyProgramResponse": ".types",
}
