...
import brevo_python
from brevo_python.api.transactional_sms_api import TransactionalSMSApi  # noqa: E501
...
class TestTransactionalSMSApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = brevo_python.api.transactional_sms_api.TransactionalSMSApi()  # noqa: E501
